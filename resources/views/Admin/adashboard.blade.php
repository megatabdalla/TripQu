            ...
            <div class="main-content flex flex-col min-h-screen">
                        ...
                        <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
                            <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                                <a href="/adashboard" class="main-logo flex shrink-0 items-center">
                                    <img class="inline w-8 ltr:-ml-1 rtl:-mr-1" src="admin/images/logo.png" alt="image">
                            ...
                            <div x-data="header" class="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                                ...
                                <div class="dropdown shrink-0" x-data="dropdown" @click.outside="open = false">
                                    <a href="javascript:;" class="block rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60" @click="toggle">
                                        <img :src="`admin/images/flags/${$store.app.locale.toUpperCase()}.svg`" alt="image" class="h-5 w-5 rounded-full object-cover">
                                    </a>
                                        ...
                                        <template x-for="item in languages">
                                            <li>
                                                <a href="javascript:;" class="hover:text-primary" @click="$store.app.toggleLocale(item.value),toggle()" :class="{'bg-primary/10 text-primary' : $store.app.locale == item.value}">
                                                    <img class="h-5 w-5 rounded-full object-cover" :src="`admin/images/flags/${item.value.toUpperCase()}.svg`" alt="image">
                                                ...
                                                <div class="group flex items-center px-4 py-2" @click.self="toggle">
                                                    <div class="grid place-content-center rounded">
                                                        <div class="relative h-12 w-12">
                                                            <img class="h-12 w-12 rounded-full object-cover" :src="`admin/images/${notification.profile}`" alt="image">
                                ...
                                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                    <a href="javascript:;" class="group relative" @click="toggle()">
                                        <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="admin/images/user-profile.jpeg" alt="image"></span>
                                    </a>
                                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                <div class="flex-none">
                                                    <img class="h-10 w-10 rounded-md object-cover" src="admin/images/user-profile.jpeg" alt="image">
                                                </div>
                ...
                <div class="animate__animated p-6" :class="[$store.app.animation]">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-6 pt-5 xl:grid-cols-2" x-data="form">
                            <!-- Profile -->
                            <div class="panel">
                                ...
                                <div class="mb-5">
                                    <p class="mb-5 text-base font-bold text-white-dark">Today</p>
                                    <div class="sm:flex">
                                        <div class="relative z-[2] mx-auto mb-5 before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-z-[1] before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block ltr:sm:mr-8 rtl:sm:ml-8">
                                            <img src="admin/images/profile-16.jpeg" alt="image" class="mx-auto h-12 w-12 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]">
                                        </div>
                                        <div class="flex-1">
                                            <h4 class="text-center text-xl font-bold text-primary ltr:sm:text-left rtl:sm:text-right">Laurie Fox</h4>
                                            <p class="text-center ltr:sm:text-left rtl:sm:text-right">5 sec</p>
                                            <div class="mt-4 mb-16 sm:mt-7">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline-block h-5 w-5 align-text-bottom text-white-dark ltr:mr-2.5 rtl:ml-2.5">
                                                ...
                                                <h6 class="mb-2 inline-block text-lg font-bold">Trending Style</h6>
                                                <p class="font-semibold text-white-dark ltr:pl-8 rtl:pr-8">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                                                    dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
                                                    ea commodo consequat.
                                                </p>
                                                <div class="mt-6 flex space-x-1 ltr:pl-8 rtl:space-x-reverse rtl:pr-8">
                                                    <img src="admin/images/profile-16.jpeg" alt="image" class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/drag-1.jpeg" alt="image" class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/drag-2.jpeg" alt="image" class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/profile-16.jpeg" alt="image" class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/drag-4.jpg" alt="image" class="relative top-0 h-10 w-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sm:flex">
                                        <div class="relative z-[2] mx-auto mb-5 before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-z-[1] before:hidden before:h-auto before:w-0 before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] dark:before:border-[#191e3a] sm:mb-0 sm:before:block ltr:sm:mr-8 rtl:sm:ml-8">
                                            <img src="admin/images/profile-7.jpeg" alt="image" class="mx-auto h-12 w-12 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]">
                                        </div>
                                        <div class="flex-1">
                                            <h4 class="text-center text-xl font-bold text-primary ltr:sm:text-left rtl:sm:text-right">Justin Cross</h4>
                                            ...
                                            <div class="mt-4 mb-16 sm:mt-7">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline-block h-5 w-5 align-text-bottom text-white-dark ltr:mr-2.5 rtl:ml-2.5">
                                                    ...
                                                    <circle opacity="0.5" cx="16" cy="8" r="2" stroke="currentColor" stroke-width="1.5"></circle>
                                                    <path opacity="0.5" d="M2 12.5001L3.75159 10.9675C4.66286 10.1702 6.03628 10.2159 6.89249 11.0721L11.1822 15.3618C11.8694 16.0491 12.9512 16.1428 13.7464 15.5839L14.0446 15.3744C15.1888 14.5702 16.7369 14.6634 17.7765 15.599L21 18.5001" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                </svg>
                                                <h6 class="mb-2 inline-block text-lg font-bold">Nature Photography</h6>
                                                <p class="font-semibold text-white-dark ltr:pl-8 rtl:pr-8">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                                                    dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
                                                    ea commodo consequat.
                                                </p>
                                                <div class="mt-6 grid grid-cols-3 gap-3 ltr:pl-8 rtl:pr-8 sm:grid-cols-5 lg:grid-cols-8">
                                                    <img src="admin/images/drag-1.jpeg" alt="image" class="relative top-0 w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/profile-16.jpeg" alt="image" class="relative top-0 w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                    <img src="admin/images/drag-4.jpg" alt="image" class="relative top-0 w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] transition-all duration-300 hover:-top-0.5 hover:shadow-none">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="sm:flex">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-center ltr:sm:text-left rtl:sm:text-right">5 sec</p>
                                            <div class="mt-4 mb-16 sm:mt-7">
                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="inline-block h-4.5 w-4.5 align-text-bottom text-white-dark ltr:mr-2.5 rtl:ml-2.5">
                                                ...
                                                <h6 class="mb-2 inline-block text-lg font-bold">Create new Project</h6>
                                                <p class="font-semibold text-white-dark ltr:pl-8 rtl:pr-8">
                                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
                                                    dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
                                                    ea commodo consequat.
...
&lt;div class=&quot;mb-5&quot;&gt;
    ...
    &lt;div class=&quot;sm:flex&quot;&gt;
        &lt;div class=&quot;relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-16.jpeg&quot; alt=&quot;image&quot; class=&quot;w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]&quot; /&gt;
        &lt;/div&gt;
        &lt;div class=&quot;flex-1&quot;&gt;
            ...
            &lt;div class=&quot;mt-4 sm:mt-7 mb-16&quot;&gt;
                ...
                &lt;div class=&quot;ltr:pl-8 rtl:pr-8 flex space-x-1 rtl:space-x-reverse mt-6&quot;&gt;
                    &lt;img src=&quot;/admin/images/profile-16.jpeg&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/drag-1.jpeg&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/drag-2.jpeg&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/profile-16.jpeg&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/drag-4.jpg&quot; alt=&quot;image&quot; class=&quot;w-10 h-10 rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
    ...
    &lt;div class=&quot;sm:flex&quot;&gt;
        &lt;div class=&quot;relative mx-auto mb-5 sm:mb-0 ltr:sm:mr-8 rtl:sm:ml-8 z-[2] before:absolute before:top-12 before:left-1/2 before:-bottom-[15px] before:-translate-x-1/2 before:border-l-2 before:border-[#ebedf2] before:w-0 before:h-auto before:-z-[1] dark:before:border-[#191e3a] before:hidden sm:before:block&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-7.jpeg&quot; alt=&quot;image&quot; class=&quot;w-12 h-12 mx-auto rounded-full shadow-[0_4px_9px_0_rgba(31,45,61,0.31)]&quot; /&gt;
        &lt;/div&gt;
        &lt;div class=&quot;flex-1&quot;&gt;
            ...
            &lt;div class=&quot;mt-4 sm:mt-7 mb-16&quot;&gt;
                ...
                &lt;div class=&quot;ltr:pl-8 rtl:pr-8 grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-8 gap-3 mt-6&quot;&gt;
                    &lt;img src=&quot;/admin/images/drag-1.jpeg&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/profile-16.jpeg&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                    &lt;img src=&quot;/admin/images/drag-4.jpg&quot; alt=&quot;image&quot; class=&quot;w-full rounded-md shadow-[0_4px_9px_0_rgba(31,45,61,0.31)] relative top-0 transition-all duration-300 hover:-top-0.5 hover:shadow-none&quot; /&gt;
                &lt;/div&gt;
            &lt;/div&gt;
        &lt;/div&gt;
    &lt;/div&gt;
...
&lt;/div&gt;
                            ...
                            <div class="panel">
                                <div class="mb-5 flex items-center justify-between">
                                    <h5 class="text-lg font-semibold dark:text-white-light">Modern</h5>
                                ...
                                <div class="mb-5 inline-block w-full">
                                    <ul class="relative mx-auto table max-w-[900px] py-12 before:absolute before:bottom-0 before:left-1/2 before:top-0 before:-ml-[1.5px] before:w-[3px] before:bg-[#ebedf2] dark:before:bg-[#191e3a]">
                                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                                            <div class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-info dark:border-[#191e3a] sm:block"></div>
                                            <div class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-right-[37px] rtl:before:-left-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-left rtl:sm:float-right">
                                                <div>
                                                    <img src="admin/images/carousel1.jpeg" alt="timeline" class="w-full rounded-t-md">
                                                </div>
                                                <div class="p-5">
                                                    <h4 class="mb-3 text-lg font-semibold text-info">Front-End Framework</h4>
                                                    <p class="mb-3 text-white-dark">
                                                        Map where your photos were taken and discover local points of interest. Map where your photos. Map where
                                        ...
                                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                                            <div class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-primary dark:border-[#191e3a] sm:block"></div>
                                            <div class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-left-[37px] rtl:before:-right-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-right rtl:sm:float-left">
                                                <div>
                                                    <img src="admin/images/menu-heade.jpg" alt="timeline" class="w-full rounded-t-md">
                                                </div>
                                                <div class="p-5">
                                                    <h4 class="mb-3 text-lg font-semibold text-primary">Web Development</h4>
                                                    <p class="mb-3 text-white-dark">
                                                        Map where your photos were taken and discover local points of interest. Map where your photos. Map where
                                                        your photos were taken and discover.
                                                    </p>
                                        ...
                                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                                            <div class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-success dark:border-[#191e3a] sm:block"></div>
                                            <div class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-right-[37px] rtl:before:-left-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-left rtl:sm:float-right">
                                                <div>
                                                    <img src="admin/images/carousel1.jpeg" alt="timeline" class="w-full rounded-t-md">
                                                </div>
                                                <div class="p-5">
                                                    <h4 class="mb-3 text-lg font-semibold text-success">Theme Development</h4>
                                                    <p class="mb-3 text-white-dark">
                                                        Map where your photos were taken and discover local points of interest. Map where your photos. Map where
                                                        your photos were taken and discover.
                                                    </p>
                                        ...
                                        <li class="relative mb-12 before:clear-both before:table after:clear-both after:table">
                                            <div class="absolute left-1/2 top-[32px] z-[1] -ml-2.5 hidden h-5 w-5 rounded-full border-[3px] border-[#ebedf2] bg-danger dark:border-[#191e3a] sm:block"></div>
                                            <div class="relative mx-auto w-full max-w-[320px] rounded-md border border-[#ebedf2] bg-white shadow-[0_20px_20px_rgba(126,142,177,0.12)] before:absolute before:top-10 before:hidden before:h-[3px] before:w-[37px] before:rounded-full before:bg-[#ebedf2] ltr:before:-left-[37px] rtl:before:-right-[37px] dark:border-[#191e3a] dark:bg-[#191e3a] dark:before:bg-[#191e3a] sm:w-[46%] sm:max-w-full sm:before:block ltr:sm:float-right rtl:sm:float-left">
                                                <div>
                                                    <img src="admin/images/menu-heade.jpg" alt="timeline" class="w-full rounded-t-md">
                                                </div>
                                                <div class="p-5">
                                                    <h4 class="mb-3 text-lg font-semibold text-danger">Plugin Development</h4>
                                                    <p class="mb-3 text-white-dark">
                                                        Map where your photos were taken and discover local points of interest. Map where your photos. Map where
                                                        your photos were taken and discover.
                                                    </p>
...
&lt;/div&gt;
                            ...
                            <div class="panel">
                                <div class="mb-5 flex items-center justify-between">
                                    <h5 class="text-lg font-semibold dark:text-white-light">With Images</h5>
                                ...
                                <div class="mb-5">
                                    <div class="mx-auto max-w-[900px] space-y-3 text-center sm:space-y-0 ltr:sm:text-left rtl:sm:text-right">
                                        <div class="items-center sm:flex">
                                            <p class="p-2.5 text-base font-semibold text-[#3b3f5c] dark:text-white-light">09:00</p>
                                            <div class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                                <img src="admin/images/profile-16.jpeg" alt="image" class="relative z-[1] mx-auto h-11 w-11 rounded-full">
                                            </div>
                                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">
                                                25 mins ago
                                            </p>
                                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">
                                                Conference call with Marketing Manager.
                                            </p>
                                        </div>
                                        <div class="items-center sm:flex">
                                            <p class="p-2.5 text-base font-semibold text-[#3b3f5c] dark:text-white-light">10:00</p>
                                            <div class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                                <img src="admin/images/profile-1.jpeg" alt="image" class="relative z-[1] mx-auto h-11 w-11 rounded-full">
                                            </div>
                                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">
                                                2 hrs ago
                                            </p>
                                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">Server rebooted successfully</p>
                                        </div>
                                        <div class="items-center sm:flex">
                                            <p class="p-2.5 text-base font-semibold text-[#3b3f5c] dark:text-white-light">11:00</p>
                                            <div class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                                <img src="admin/images/profile-2.jpeg" alt="image" class="relative z-[1] mx-auto h-11 w-11 rounded-full">
                                            </div>
                                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">
                                                4 hrs ago
                                            </p>
                                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">Backup Files EOD</p>
                                        </div>
                                        <div class="items-center sm:flex">
                                            <p class="p-2.5 text-base font-semibold text-[#3b3f5c] dark:text-white-light">12:00</p>
                                            <div class="relative p-2.5 after:absolute after:left-1/2 after:top-[25px] after:-bottom-[15px] after:h-auto after:w-0 after:-translate-x-1/2 after:rounded-full after:border-l-2 after:border-white-dark/20">
                                                <img src="admin/images/profile-3.jpeg" alt="image" class="relative z-[1] mx-auto h-11 w-11 rounded-full">
                                            </div>
                                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">
                                                6 hrs ago
                                            </p>
                                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">Collected documents from Sara</p>
                                        </div>
                                        <div class="items-center sm:flex">
                                            <p class="p-2.5 text-base font-semibold text-[#3b3f5c] dark:text-white-light">01:00</p>
                                            <div class="relative p-2.5">
                                                <img src="admin/images/profile-4.jpeg" alt="image" class="relative z-[1] mx-auto h-11 w-11 rounded-full">
                                            </div>
                                            <p class="mt-5 self-center p-2.5 text-xs font-bold text-white-dark sm:mt-0 sm:min-w-[100px] sm:max-w-[100px]">
                                                9 hrs ago
                                            </p>
                                            <p class="p-2.5 text-[13px] font-semibold text-[#3b3f5c] dark:text-white-light">PDF file Download</p>
                                        </div>
                                    </div>
                                </div>
...
&lt;div class=&quot;max-w-[900px] mx-auto text-center ltr:sm:text-left rtl:sm:text-right space-y-3 sm:space-y-0&quot;&gt;
    &lt;div class=&quot;sm:flex items-center&quot;&gt;
        ...
        &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-16.jpeg&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
        &lt;/div&gt;
    ...
    &lt;div class=&quot;sm:flex items-center&quot;&gt;
        ...
        &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-1.jpeg&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
        &lt;/div&gt;
    ...
    &lt;div class=&quot;sm:flex items-center&quot;&gt;
        ...
        &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-2.jpeg&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
        &lt;/div&gt;
    ...
    &lt;div class=&quot;sm:flex items-center&quot;&gt;
        ...
        &lt;div class=&quot;p-2.5 relative after:absolute after:left-1/2 after:-translate-x-1/2 after:top-[25px] after:-bottom-[15px] after:w-0 after:h-auto after:border-l-2 after:border-white-dark/20 after:rounded-full&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-3.jpeg&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
        &lt;/div&gt;
    ...
    &lt;div class=&quot;sm:flex items-center&quot;&gt;
        ...
        &lt;div class=&quot;p-2.5 relative&quot;&gt;
            &lt;img src=&quot;/admin/images/profile-4.jpeg&quot; alt=&quot;image&quot; class=&quot;w-11 h-11 rounded-full relative z-[1] mx-auto&quot; /&gt;
        &lt;/div&gt;
